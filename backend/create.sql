create table tb_movie (id int8 generated by default as identity, count int4, image varchar(255), score double precision, title varchar(255), primary key (id));
create table tb_score (value double precision, movie_id bigint not null, user_id bigint not null, primary key (movie_id, user_id));
